    ...
    <div className="flex flex-col gap-2  ">
      ...
      <div className="flex  w-full flex-wrap gap-y-2  ">
        ...
        <input
          ...
          className="form-style  bg-richblack-700 outline-none p-2 rounded-lg w-full pl-3 text-richblack-5 border-b border-richblack-200 focus:border-yellow-50 shadow-[0_1px_0_0] shadow-white/50"
        />
      </div>
